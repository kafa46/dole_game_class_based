...
class WindowManager():
    def __init__(self, num_doles=3) -> None:
        ...
        self.window_names = ['Dole', 'Player', 'Information']
        self.windows_info = {
            'Dole': {
                'location': None,
                'height': None,
    ...
    def create_windows(self, doleX_ratio=0.6, doleY_ratio=0.8):
        ...
        self.windows_info['Dole']['location'] = dole_loc
        self.windows_info['Dole']['height'] = dole_win_height
        self.windows_info['Dole']['width'] = dole_win_width
        ...
        self.windows_info['Information']['height'] = player_win_height
